...
module.exports = {
  ...
  */
  identify: function (properties, isUpdate) {
    return when.promise(function (resolve, reject) {
      ...
      var createRequiredFields = ['id', 'created_at', 'email'];
      var updateRequiredFields = ['id'];

      var required = isUpdate ? updateRequiredFields : createRequiredFields;
  ...
  /*
  * Sugar method to update, using identify
  */

  update: function (properties) {
    return this.identify(properties, true);
  },
